/*
 * The ArduGlove simple serial example demonstrates communication with an Arduino attached to a PC running AnimationPrepStudio.
...
void loop() {
    ...
    int _B0 = analogRead(A0);  
    int _B1 = analogRead(A1);  
    int _B2 = analogRead(A2);  
    int _B3 = analogRead(A3);
    int _B4 = analogRead(A4);  
